...
<!-- 
    - custom css link
  -->
<link rel="stylesheet" href="<c:url value='/assets/css/mainStyle.css'/>" />
<link rel="stylesheet" href="<c:url value='/assets/css/customStyle.css'/>" />
	...
	<main>
      ...
      -->
			<section class="hero" id="home"
				style="background-image: url('./assets/images/wedding-1.jpeg')">
				<div class="container">
					<div class="hero-content">
						<p class="hero-subtitle">Professional</p>

						<h2 class="h1 hero-title">Best banquet booking service in
							city!</h2>

						<p class="hero-text">Dedication and thoughtfulness bring
							satisfaction to you</p>

						<button class="btn">Book a banquet</button>
					</div>

					<figure class="hero-banner">
						<img src="./assets/images/hero-banner-bg.png" width="820"
							height="716" alt="" aria-hidden="true" class="w-100 hero-img-bg" />

						<img src="./assets/images/steak.png" width="700" height="637"
                      ...
                      <defs>
                        <clipPath id="A">
                          <path fill="#fff" d="M0 0h60v60H0z" />
								...
								<p class="card-text">Food is any substance consumed to
									provide nutritional support for an organism.</p>

								<img src="./assets/images/promo-1.png" width="300" height="300"
                      ...
                      <defs>
                        <clipPath id="A">
                          <path fill="#fff" d="M0 0h60v60H0z" />
								...
								<img src="./assets/images/promo-2.png" width="300" height="300"
                      ...
                      <defs>
                        <clipPath id="A">
                          <path fill="#fff" d="M0 0h60v60H0z" />
								...
								<img src="./assets/images/promo-3.png" width="300" height="300"
                      ...
                      <defs>
                        <clipPath id="A">
                          <path fill="#fff" d="M0 0h60v60H0z" />
								...
								<img src="./assets/images/promo-4.png" width="300" height="300"
                      ...
                      <defs>
                        <clipPath id="A">
                          <path fill="#fff" d="M0 0h60v60H0z" />
								...
								<img src="./assets/images/promo-5.png" width="300" height="300"
			...
			<section class="section section-divider gray about" id="about">
				<div class="container">
					<div class="about-banner">
						<img src="./assets/images/about-banner.jpg" width="509"
							height="459" loading="lazy" alt="Burger with Drinks"
              ...
              /> -->
					...
					<div class="about-content">
						<h2 class="h2 section-title">
							<span class="span">OBBM:</span> Your Online Catering Solution
						</h2>

						<p class="section-text">At OBBM, we offer you a seamless and
							efficient online catering service with uncompromising quality.
							Our team comprises dedicated professionals who are always ready
							to serve you with utmost sincerity. With our highly skilled chefs
							from around the globe, we promise to tantalize your taste buds
							with exquisite flavors at your event. Equipped with modern
							facilities and catering to diverse themes, we ensure to exceed
							your expectations every time.</p>

						<ul class="about-list">
							<li class="about-item"><ion-icon name="checkmark-outline"></ion-icon>

								<span class="span">Delicious & Healthy Foods</span></li>

							<li class="about-item"><ion-icon name="checkmark-outline"></ion-icon>

								<span class="span">Professional and dedicated team</span></li>

							<li class="about-item"><ion-icon name="checkmark-outline"></ion-icon>

								<span class="span">Music & Other Facilities</span></li>

							<li class="about-item"><ion-icon name="checkmark-outline"></ion-icon>

								<span class="span">Enthusiastic support and advice</span></li>
						</ul>

						<button class="btn btn-hover">Booking Now</button>
					</div>
				</div>
			</section>
				...
				<div class="container">
					...
					<ul class="food-menu-list">
						<li>
							<div class="food-menu-card">
								<div class="card-banner">
									<img src="./assets/images/food-menu-1.png" width="300"
										height="300" loading="lazy" alt="Fried Chicken Unlimited"
										class="w-100" />

									<div class="badge">-15%</div>

									<button class="btn food-menu-btn">Add To Menu</button>
								</div>
						...
						<li>
							<div class="food-menu-card">
								<div class="card-banner">
									<img src="./assets/images/food-menu-2.png" width="300"
										height="300" loading="lazy" alt="Burger King Whopper"
										class="w-100" />
						...
						<li>
							<div class="food-menu-card">
								<div class="card-banner">
									<img src="./assets/images/food-menu-3.png" width="300"
										height="300" loading="lazy" alt="White Castle Pizzas"
										class="w-100" />
						...
						<li>
							<div class="food-menu-card">
								<div class="card-banner">
									<img src="./assets/images/food-menu-4.png" width="300"
										height="300" loading="lazy" alt="Bell Burrito Supreme"
										class="w-100" />
						...
						<li>
							<div class="food-menu-card">
								<div class="card-banner">
									<img src="./assets/images/food-menu-5.png" width="300"
										height="300" loading="lazy" alt="Kung Pao Chicken BBQ"
										class="w-100" />
						...
						<li>
							<div class="food-menu-card">
								<div class="card-banner">
									<img src="./assets/images/food-menu-6.png" width="300"
										height="300" loading="lazy" alt="Wendy's Chicken"
										class="w-100" />
      ...
      -->
			...
			<section class="section section-divider white cta"
				style="background-image: url('./assets/images/wedding-2.jpg')">
				<div class="container">
					<div class="cta-content">
						<h2 class="h2 section-title">
							Crafted Cocktails: Taste the <span class="span">Difference</span>
						</h2>

						<p class="section-text">At OBBM, our professional bartenders
							expertly craft bespoke drinks to elevate your event experience.
							From classic cocktails to innovative concoctions, we ensure every
							sip is unforgettable</p>

						<button class="btn btn-hover">Order Now</button>
					</div>

					<figure class="cta-banner">
						<img src="./assets/images/hero-banner-bg.png" width="700"
							height="637" loading="lazy" alt="Burger" class="w-100 cta-img" />
						<!-- 
              <img
			...
			<section class="section section-divider gray delivery">
				<div class="container">
					<div class="delivery-content">
						...
						<p class="section-text">The restaurants in Hangzhou also
							catered to many northern Chinese who had fled south from Kaifeng
							during the Jurchen invasion of the 1120s, while it is also known
							that many restaurants were run by families.</p>

						<button class="btn btn-hover">Order Now</button>
					</div>

					<figure class="delivery-banner">
						<img src="./assets/images/flower-1.jpg" width="700" height="602"
					...
					<ul class="testi-list has-scrollbar">
						<li class="testi-item">
							<div class="testi-card">
								...
								<blockquote class="testi-text">"I would be lost
									without restaurant. I would like to personally thank you for
									your outstanding product."</blockquote>
					...
					<ul class="banner-list">
						<li class="banner-item banner-lg">
							<div class="banner-card">
								<img src="./assets/images/wedding-stage.jpg" width="550"
									height="450" loading="lazy"
									alt="Discount For Delicious Tasty Burgers!" class="banner-img" />

								<div class="banner-item-content">
									<p class="banner-subtitle">20% Off Now!</p>

									<h3 class="banner-title">Elegant White Wedding Stage</h3>

									<p class="banner-text">Sale off 20% only this week</p>
						...
						<li class="banner-item banner-sm">
							<div class="banner-card">
								<img src="./assets/images/flower-crown.jpg" width="550"
									height="465" loading="lazy" alt="Delicious Pizza"
									class="banner-img" />

								<div class="banner-item-content">
									<h3 class="banner-title">Flower Crown</h3>

									<p class="banner-text">"Summer Love Package: Included with
										Your Wedding Reservation this Season."</p>
						...
						<li class="banner-item banner-sm">
							<div class="banner-card">
								<img src="./assets/images/event-2.jpg" width="550" height="465"
									loading="lazy" alt="American Burgers" class="banner-img" />

								<div class="banner-item-content">
									<h3 class="banner-title">Dosa chicken crepe</h3>
						...
						<li class="banner-item banner-md">
							<div class="banner-card">
								<img src="./assets/images/turkey.jpeg" width="550" height="220"
									loading="lazy" alt="Tasty Buzzed Pizza" class="banner-img" />

								<div class="banner-item-content">
									<h3 class="banner-title">Thanksgiving Turkey</h3>

									<p class="banner-text">Sale off 20% in this thanksgiving</p>
      ...
      -->
			...
			<section class="section section-divider white blog" id="blog">
				<div class="container">
					...
					<h2 class="h2 section-title">
						Our Signature <span class="span">Celebratory Events</span>
					</h2>

					<p class="section-text">Where Every Occasion Sparkles!</p>

					<ul class="blog-list">
						<li>
							<div class="blog-card">
								<div class="card-banner">
									<img src="./assets/images/blog-1.jpg" width="600" height="390"
										loading="lazy"
								...
								<div class="card-content">
									<div class="card-meta-wrapper">
										<a href="#" class="card-meta-link"> <ion-icon
												name="calendar-outline"></ion-icon> <time class="meta-info"
												datetime="2022-01-01">Jan
												01 2022</time>
										</a> <a href="#" class="card-meta-link"> <ion-icon
									...
									<h3 class="h3">
										<a href="#" class="card-title">The
											Theatre Bar at the End of the Wharf in Dawes Point</a>
									</h3>

									<p class="card-text">Financial experts support or help you
										to to find out which way you can raise your funds more...</p>

									<a href="#" class="btn-link"> <span>Read More</span> <ion-icon
											name="arrow-forward" aria-hidden="true"></ion-icon>
									</a>
								</div>
							</div>
						</li>
						...
						<li>
							<div class="blog-card">
								<div class="card-banner">
									<img src="./assets/images/blog-2.jpg" width="600" height="390"
										loading="lazy"
								...
								<div class="card-content">
									...
									<h3 class="h3">
										<a href="#" class="card-title">Establishment
											Bar by Merivale in Sydney CBD</a>
									</h3>

									<p class="card-text">Attached to the main bar is the garden
										â an industrial-style terrace area where drinking, dancing,
										and generally having a great time are encouraged. For an
										indulgent yet refined Sydney restaurant wedding, Establishment
										Bar should top your list.</p>
						...
						<li>
							<div class="blog-card">
								<div class="card-banner">
									<img src="./assets/images/blog-3.jpg" width="600" height="390"
										loading="lazy"
								...
								<div class="card-content">
									...
									<h3 class="h3">
										<a href="#" class="card-title">Cruise
											Bar Sydney in The Rocks.</a>
									</h3>
